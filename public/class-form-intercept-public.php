...
class form_intercept_Public {
	...
	public function form_intercept_add_admin_menu(  ) { 

		/**
		* This funcion adds the menu item and register the page with Wordpress
		**/

		add_options_page( 'plugin name', 'plugin name', 'manage_options', 'form_intercept_settings', 'form_intercept_options_page' );

	}

	public function form_intercept_reports(){

		/**
		* This funcion adds the menu item and register the page with Wordpress
		**/

		add_menu_page('Login Reports', 'Login Reports', 'manage_options', 'form_intercept_reports', 'form_intercept_report_page_render');
	}
		/** 
	...
	public function form_intercept_settings_init(  ) { 
		...
		register_setting( 'pluginPage', 'form_intercept_settings' );

		add_settings_section(
			'form_intercept_pluginPage_section', 
			__( 'API Keys', 'form_intercept' ), 
			'form_intercept_settings_section_callback', 
			'pluginPage'
		);
